...
module.exports = function (app) {
    app.on("pull_request.opened", function (context) { return __awaiter(_this, void 0, void 0, function () {
        var config, author, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, context.config("dependabot-team-assign.yml")];
                case 1:
                    config = _a.sent();
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, context.github.pullRequests.createReviewRequest(context.issue({
                            reviewers: [],
